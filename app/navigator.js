...
const SovrinConnectorAppNavigator = createStackNavigator(
  {
...
let navigator = SovrinConnectorAppNavigator

// Temporary disabled
// Reason:
// Ref to SovrinConnectorAppNavigator on App component was not working as expected
