...
jest.mock('react-native-sensitive-info', () => {
  ...
  return {
    setItem: jest.fn((key, value, st) =>
      Promise.resolve((secureStorage['SovrinConnectorKeyChain'][key] = value))
    ),
    getItem: jest.fn(key =>
      Promise.resolve(secureStorage['SovrinConnectorKeyChain'][key])
    ),
    deleteItem: jest.fn(key =>
      Promise.resolve(delete secureStorage['SovrinConnectorKeyChain'][key])
    ),
  }
})
