...
{
  [[[SovrinConnectorVcx alloc] init] deleteConnection:connectionHandle
...
RCT_EXPORT_METHOD(init: (NSString *)config
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] initWithConfig:config completion:^(NSError *error) {
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  ...
  [[[SovrinConnectorVcx alloc] init] connectionSerialize:connectionHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  ...
  [[[SovrinConnectorVcx alloc] init] connectionDeserialize:serializedConnection completion:^(NSError *error, NSInteger connectionHandle) {
    if (error != nil && error.code != 0)
    {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
...
RCT_EXPORT_METHOD(decryptWalletFile: (NSString *) config
                           ...
                           rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] importWallet: config
...
RCT_EXPORT_METHOD(shutdownVcx: (BOOL *) deletePool
                    ...
                    rejecter: (RCTPromiseRejectBlock) reject)
{
  resolve([NSNumber numberWithInt:[[[SovrinConnectorVcx alloc] init] vcxShutdown: deletePool]]);
}
...
RCT_EXPORT_METHOD(credentialCreateWithMsgId: (NSString *) sourceId
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
    [[[SovrinConnectorVcx alloc] init] credentialCreateWithMsgid:sourceId
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  ...
  [[[SovrinConnectorVcx alloc] init] credentialSerialize:credentialHandle completion:^(NSError *error, NSString *claimOffer) {
    if (error != nil && error.code != 0)
    {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  ...
  [[[SovrinConnectorVcx alloc] init] credentialDeserialize:serializedCredential
...
RCT_EXPORT_METHOD(sendClaimRequest: (NSInteger) credentialHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] credentialSendRequest:credentialHandle
                                    connectionHandle:connectionHandle
...
RCT_EXPORT_METHOD(createOneTimeInfo: (NSString *)config
                           ...
                           rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] agentProvisionAsync:config completion:^(NSError *error, NSString *oneTimeInfo) {
...
RCT_EXPORT_METHOD(createConnectionWithInvite: (NSString *)invitationId
                               inviteDetails: (NSString *)inviteDetails
                                    ...
                                    rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] connectionCreateWithInvite:invitationId
...
RCT_EXPORT_METHOD(vcxAcceptInvitation: (NSInteger )connectionHandle
                    connectionType: (NSString *)connectionType
                          ...
                          rejecter: (RCTPromiseRejectBlock) reject)
{
   [[[SovrinConnectorVcx alloc] init] connectionConnect:connectionHandle
...
RCT_EXPORT_METHOD(vcxUpdatePushToken: (NSString *)config
                         ...
                         rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] agentUpdateInfo:config completion:^(NSError *error) {
    if (error != nil && error.code != 0)
    {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
...
RCT_EXPORT_METHOD(updateClaimOfferState: (int)credentialHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] credentialUpdateState:credentialHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  ...
  [[[SovrinConnectorVcx alloc] init] credentialGetState:credentialHandle completion:^(NSError *error, NSInteger state) {
    if (error != nil && error.code != 0) {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
...
RCT_EXPORT_METHOD(getClaimVcx: (int)credentialHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] getCredential:credentialHandle completion:^(NSError *error, NSString *credential) {
    if (error != nil && error.code != 0) {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
...
RCT_EXPORT_METHOD(exportWallet: (NSString *)exportPath
                               encryptWith: (NSString *)encryptionKey
                                    ...
                                    rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] exportWallet:exportPath
                       ...
                       rejecter: (RCTPromiseRejectBlock)reject)
{
  ...
  [[[SovrinConnectorVcx alloc] init] addRecordWallet:recordType
                                      recordId:key
                                   recordValue:value
                                    completion:^(NSError *error) {
    if (error != nil && error.code != 0)
...
{
  NSString *recordType = @"record_type";
  [[[SovrinConnectorVcx alloc] init] getRecordWallet:recordType
                                      recordId:key
...
{
  NSString *recordType = @"record_type";
  [[[SovrinConnectorVcx alloc] init] deleteRecordWallet:recordType
                                         recordId:key
                                       completion:^(NSError *error) {
     if (error != nil && error.code != 0)
     {
                          ...
                          rejecter: (RCTPromiseRejectBlock) reject)
{
  ...
  [[[SovrinConnectorVcx alloc] init] updateRecordWallet:recordType
                                     withRecordId:key
...
RCT_EXPORT_METHOD(proofCreateWithMsgId: (NSString *)sourceId
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] proofCreateWithMsgId:sourceId
...
RCT_EXPORT_METHOD(proofRetrieveCredentials:(NSInteger)proofHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] proofRetrieveCredentials:proofHandle
...
RCT_EXPORT_METHOD(proofGenerate:(NSInteger)proofHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] proofGenerate:proofHandle
...
RCT_EXPORT_METHOD(proofSend:(NSInteger)proof_handle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] proofSend:proof_handle
...
RCT_EXPORT_METHOD(proofCreateWithRequest:(NSString*)sourceId
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] proofCreateWithRequest:sourceId
...
RCT_EXPORT_METHOD(proofSerialize:(NSInteger)proofHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] proofSerialize:proofHandle
...
RCT_EXPORT_METHOD(proofDeserialize:(NSString *)serializedProof
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] proofDeserialize:serializedProof
                                 withCompletion:^(NSError *error, vcx_proof_handle_t proofHandle)
  {
    if (error != nil && error.code != 0) {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
...
RCT_EXPORT_METHOD(downloadMessages: (NSString *) messageStatus
                          ...
                          rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] downloadMessages: messageStatus uid_s:uid_s pwdids:pwdids completion:^(NSError *error, NSString *messages) {
    if (error != nil && error.code !=0) {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
 ...
 RCT_EXPORT_METHOD(updateMessages: (NSString *)messageStatus
                      pwdidsJson: (NSString *)pwdidsJson
                        ...
                        rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] updateMessages:messageStatus pwdidsJson:pwdidsJson completion:^(NSError *error) {
    if (error != nil && error.code !=0) {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
...
RCT_EXPORT_METHOD(getTokenInfo:(NSInteger) paymentHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] getTokenInfo:paymentHandle withCompletion:^(NSError *error, NSString *tokenInfo) {
    if (error != nil && error.code != 0)
    {
      NSString *indyErrorCode = [NSString stringWithFormat:@"%ld", (long)error.code];
...
RCT_EXPORT_METHOD(sendTokens:(NSInteger) paymentHandle
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] sendTokens:paymentHandle
                               withTokens:tokens
...
RCT_EXPORT_METHOD(createPaymentAddress:(NSString*)seed
                  ...
                  rejecter: (RCTPromiseRejectBlock) reject)
{
  [[[SovrinConnectorVcx alloc] init] createPaymentAddress:seed
